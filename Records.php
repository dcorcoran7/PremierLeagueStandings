...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet"  type="text/css" href="./styleRecords.css">
    ...
    <body>
        <main>
            <div class="Header">
                ...
                <div class="titleDiv">
                    <h1 class="title">Premier League Records</h1>
                </div>
            ...
            <nav class="navGrid">
                ...
                <button id="button" class="Current" onclick = "location.href='Records.php'">Records</button>
            </nav>
